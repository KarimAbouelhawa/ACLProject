...
function Course() {
    ...
    React.useEffect(() => {
        async function checkCourses() {
            ...
            let found = res.data.filter(
                course => course.CourseName === thisCourse
            );
    ...
    return (
        <div>
            ...
            <div className="page">
                ...
                <br></br>
                <u>
                    <h2 id="previewTitle">Course Preview:</h2>
                </u>
                <div id="videoBox">
                    <div className="video">
                    ...
                    <div className="outline">
                        ...
                        <center>
                            <Link to={`../${thisCourse}/CourseExercise`}>
                                <button className="lessonbuttons">
                                    Take Exam
                                </button>
                            </Link>
                ...
                {!hasCourse && (
                    <div>
                        <center>
                            <button className="paybuttons">
                                Register Using Wallet
                            </button>
